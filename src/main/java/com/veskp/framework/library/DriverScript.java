package com.veskp.framework.library;
...
import com.veskp.framework.core.ReportThemeFactory.Theme;
...
public class DriverScript
{
	...
	private void initializeWebDriver()
	{
		...
		case Mobile:
			driver = WebDriverFactory.getDriver(properties.getProperty("MobileOS"));												
			break;
	...
	private TestCase getTestCaseInstance()
	{
		...
		try {
			...
			testScriptClass = Class.forName("com.veskp.test." +
