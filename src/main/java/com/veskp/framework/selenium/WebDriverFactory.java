...
{		
  ...
  public static WebDriver getDriver(String mobileOS)
  {
	  ...
	  capabilities.setCapability("platformName", mobileOS);
	  ...
	  if (mobileOS.equalsIgnoreCase("Android")){
		  ...
		  capabilities.setCapability("platformVersion", properties.getProperty("iOSVersion"));
